...
local ClosureBindings = {
    function()
        ...
        function Library.GetShine(self)
            local thm = require(Root.Themes)[Library.Theme]
        ...
        Elements.AddSection = function(self, Title, IconKey)
            ...
            local built = require(Components.Section)(Title, (IconKey ~= "" and IconKey or nil), self.Container)
            local sectionObj = {
                Type = "Section",
            ...
            if username == "" and type(profileUrl) == "string" then
                ...
                if host then
                    ...
                    local _hostMap = {
                        ...
                        ["NotificationModule.me"]="telegram", ["soundcloud.com"]="soundcloud", ["steamcommunity.com"]="steam",
                    }
            ...
            task.spawn(function()
                ...
                local function _slugFromHost(hostUrl)
                    ...
                    local hostMap = {
                        ...
                        ["NotificationModule.me"] = "telegram",
        ...
        function Library.SetTheme(C, D)
            if Library.Window and (table.find(Library.Themes, D) or (type(D)=="string" and type(require(Root.Themes)[D])=="table")) then
                Library.Theme = D
                Creator.UpdateTheme()
                local thm = require(Root.Themes)[D]
                if thm then
        ...
        function Library.RegisterCustomTheme(C, D, E)
            ...
            local baseTheme = require(Root.Themes)["Dark"]
        ...
        function Library.CreateMinimizer(_, cfg)
            ...
            mGui.Enabled = false
            pcall(function() ProtectGui(mGui) end)
            mGui.Parent = RunService:IsStudio()
        ...
        if getgenv then
            pcall(function() getgenv().Fluent_Themes = require(Root.Themes) end)
